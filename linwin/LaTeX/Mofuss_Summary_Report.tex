...
Mofuss produce summary results by administrative units that could be useful for understanding NRB at coarser level. For this table to be meaningful, it is recommended that the analysis area house entire administrative units. Tables \ref{tab:NRB} and \ref{tab:fNRB} show results for the chosen Adminsitrative Units for the \input{../LULCC/TempTables/Country.txt} case study.
