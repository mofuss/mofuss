...
agb_year   <- 31L      # year code for AGB 2050 (51 = 2050, matches Growth_less_harvXX naming)
...
if (fixdir == 1L) {
  configs_fixed <- list(
    list(label = "capped",
         ...
         emis  = "ken_1km_2030_v3_emissions_ng_ics3_ics3"),
    list(label = "uncapped",
         bau   = "D:/ken_1km_bau1_2030_v3_g",
         ics   = "D:/ken_1km_ics3_2030_v3_g",
         emis  = "ken_1km_2030_v3_emissions_g_ics3")
  )
}
