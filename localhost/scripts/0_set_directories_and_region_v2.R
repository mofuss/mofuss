...
webmofuss = 0 # "1" is  web-MoFuSS running in our Ubuntu server, "0" is localhost (Windows or Linux)
...
if (webmofuss == 1) {
  ...
  countrydir <- "D:/malawi_1000m_bau"
  country <- "C:\\Users\\aghil\\Documents\\mofuss\\countries\\Global.tif"
  demanddir <- "D:/demand"
  admindir <- "D:/admin_regions"
  emissionsdir <- "D:/emissions"
  rTempdir <- "D:/rTemp"
  parameters_file_path <- "D:/malawi_1000m_bau/LULCC/DownloadedDatasets/SourceDataGlobal/parameters_world1000m.xlsx"
