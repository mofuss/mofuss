...
# MoFuSS ----
# Script: 2_copy_files_v3.R
# Version: 3
# Date: Sep 2026
# Execution: Source from RStudio; Dinamica EGO does not invoke this script directly.
#
# Purpose: Populate the country workspace with MoFuSS model files, demand data,
# growth tables and supporting regional inputs required by later workflow stages.
# Inputs: Repository datasets plus inherited country, demand and parameter paths.
# Outputs: Country-specific LULCC/source-data folders and runtime helper tables.
# Side effects: Changes working directory; creates, deletes, copies and overwrites
# files; invokes operating-system helper scripts.
...
# V8 is the retained, version-locked reporting bundle. V9 changes the Dinamica
# W-allocation graph; V10 extends the same component-preserving logic to V.
# Both retain the verified V8 reporting bundle. Do not point any EGOML back
# to an unsuffixed/shared R script: a later edit would silently change it.
v8_egoml <- "7_dyn_Sc17_webmofuss_ctrees_g_v8.egoml"
v9_egoml <- "7_dyn_Sc17_webmofuss_ctrees_g_v9.egoml"
v10_egoml <- "7_dyn_Sc17_webmofuss_ctrees_g_v10.egoml"
...
if (length(missing_bundle_files) > 0L) {
  stop(
    "Cannot deploy the V8/V9/V10 EGOML bundles; missing repository file(s): ",
