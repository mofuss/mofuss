...
# Regional W demand is partitioned by origin country so annual normalization in
# MoFuSS cannot transfer one country's demand to another country's component.
...
if (identical(byregion, "Regional") && as.integer(aoi_poly) == 0L) {
  ...
  writeLines(
    c(
      ...
      "",
      "Prepared by 3_demand4IDW_v10.R. IDW was not executed.",
      ...
      "Do not sum W components before MoFuSS; version 9 normalizes each origin separately after annual biomass eligibility and then sums them.",
      paste0(
