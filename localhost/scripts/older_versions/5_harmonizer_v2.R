...
# unlink("LULCC/TempRaster/DEM_c_terra.tif")  # Deletes the file
...
#   dplyr::filter(Var == "DTEM_name") %>%
#   pull(ParCHR) -> DTEM_name
# dtem_terra <- rast(paste0("LULCC/SourceData/InRaster/",DTEM_name))
# DEM_r_m_terra <- dtem_terra %>%
...
# names(DEM_r_m_terra) <- "elevation"
# writeRaster(DEM_r_m_terra, filename="LULCC/TempRaster/DEM_c_terra.tif", datatype="INT2S", overwrite=TRUE)
