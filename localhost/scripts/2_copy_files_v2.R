...
# bundles. V9 changes the Dinamica W-allocation graph but intentionally retains
# the verified V8 reporting/postprocessing R bundle. Do not point any EGOML back
...
if (length(missing_bundle_files) > 0L) {
  stop(
    "Cannot deploy the V7/V8/V9 EGOML bundles; missing repository file(s): ",
