...
temdirdefined <- 1
fixdir <-  0
string_pattern_yes <- "_1km_nv3_ng" # String pattern to be searched when selecting folders for the rasters' geocomputation
string_pattern_no <- "unfccc" # String pattern to be searched when selecting folders for the rasters' geocomputation
...
for (dir in adm0_dirs) {
  ...
  for (i in 1:length(debugging_dirs)) {
    ...
    calculated_nrb_per <- stackG[[11]] - stackGlH[[nlay]] # Bin will start in 2010 and end in the final year
    ...
    calculated_nrb <- stackG[[21]] - stackGlH[[nlay]] # Bin will start in 2020 and end in the final year
    calculated_nrb[calculated_nrb <= 0] = NA 
    assign(nrb_name, calculated_nrb)
    
    if (STdyn == 20){
      nrb_bin2010_2020 <- stackG[[11]] - stackGlH[[nlay]] # Bin will be 2010-2020
    ...
    if (STdyn == 30){
      ...
      nrb_bin2020_2030 <- stackG[[21]] - stackGlH[[nlay]] # Bin will be 2020-2030
    ...
    if (STdyn == 35){
      ...
      nrb_bin2020_2035 <- stackG[[21]] - stackGlH[[nlay]] # Bin will be 2020-2035
      nrb_bin2020_2035[nrb_bin2020_2035 <= 0] = NA 
      
    }
    
    if (STdyn == 40){ # STdyn = 30 # 2040
      nrb_bin2010_2020 <- stackG[[11]] - stackGlH[[20]] # Bin will be 2010-2020
      nrb_bin2010_2020[nrb_bin2010_2020 <= 0] = NA 
    ...
    if (STdyn == 50){ # STdyn = 40 # 2050
      ...
      nrb_bin2020_2050 <- stackG[[21]] - stackGlH[[nlay]] # Bin will be 2020-2050
    ...
    stackhar_per <- rast(paste0(debug_dir, "/", listharv_per[11:length(listharv_per)])) # Bin will start in 2010 and end in the final year
    ...
    if (STdyn == 20){
      listharv_bin2010_2020 <- listharv_per[11:nlay]
    ...
    if (STdyn == 30){
      ...
      listharv_bin2020_2030 <- listharv_per[21:nlay]
    ...
    if (STdyn == 35){
      ...
      listharv_bin2020_2035 <- listharv_per[21:nlay]
    ...
    if (STdyn == 50){
      ...
      listharv_bin2020_2050 <- listharv_per[21:nlay]
      ...
      listharv_bin2040_2050 <- listharv_per[41:nlay]
