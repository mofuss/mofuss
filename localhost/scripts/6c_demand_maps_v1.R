...
# MoFuSS ----
# Script: 6c_demand_maps_v1.R
# Version: 1
# Date: Mar 2024
# Execution: Source from RStudio; Dinamica EGO does not invoke this script directly.
#
# Purpose: Render the configured fuel-demand atlas and detailed zoom maps from
# annual demand rasters and geographic context layers.
# Inputs: Demand rasters, parameters.csv, DEM/administrative data and zoom KMLs.
# Outputs: Full-extent and zoomed demand-map figures plus cached map resources.
