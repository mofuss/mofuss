...
##  from maps_animations_v8.R, replacing the old LaTeX compile block.
##
##  Usage:
##     source(file.path(latex_dir, "generate_modern_report_v8.R"))
...
generate_modern_report <- function(base_dir,
  ...
  ## ---- master templates ---------------------------------------------------
## Keep defaults here so generate_modern_report_v8.R can be deployed on its
