...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      h4("Instructions"),
      p(class = "instruction-text", "1.- The tool estimates biomass losses vs woodfuel demand from 2010 to 2022."),
      ...
      p(class = "instruction-text", "5.- You can add countries to the list and recalculate, 
but you can't deselect countries from the list (bug), just press Clear Selection and start again."),
